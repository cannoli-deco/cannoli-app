...
class TransportCompare extends StatefulWidget {
  TransportCompare({Key key}) : super(key: key);

  @override
  _TransportCompareState createState() => _TransportCompareState();
}

class _TransportCompareState extends State<TransportCompare> {
